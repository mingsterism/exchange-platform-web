<template>
  <div>
    <div class="flex justify-center py-12 md:px-10">
      <div class="flex flex-col">
        <div class="hidden md:flex items-center mb-4 w-max">
          <!-- user icon -->
          <router-link
            to="/profile"
            class="h-10 w-10 border rounded-full overflow-hidden cursor-pointer"
          >
        ...
        >
          ...
          >
          <router-link to="/user/my-purchase" class="pt-2 border"
            >Purchase History</router-link
          >
          <router-link to="/user/add-product" class="pt-2 border"
...
export default {
  setup() {
    ...
    return { profileIcon, firstName, lastName };
  },
};
</script>
