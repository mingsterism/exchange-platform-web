<template>
  <div>
    <div
      class="w-full xl:w-auto xl:min-w-xs max-w-xs mx-auto justify-between bg-white rounded-lg shadow-lg dark:bg-gray-800 relative"
    >
      <img
      ...
      <div
        class="flex items-center justify-between px-2 md:px-4 py-1 md:py-2 bg-gray-500 rounded-b-lg"
      >
      ...
      <div
        v-if="show"
        class="absolute right-5 btmPosition rounded-md overflow-hidden z-20 text-gray-500 shadow-md"
      >
        <p
          @click="goToEditor()"
          class="py-1 px-4 flex items-center bg-white hover:shadow-lg hover:bg-blue-400 cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
        ...
        <p
          @click="removeProduct()"
          class="py-1 px-4 flex items-center bg-white hover:shadow-lg hover:bg-red-500 cursor-pointer"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            fill="currentColor"
    ...
    <!-- <div
      v-if="show"
      class="absolute right-28 btmPosition rounded-md overflow-hidden z-20 text-gray-500 shadow-md"
    >
      <p
        @click="goToEditor()"
        class="py-1 px-4 flex items-center bg-white hover:shadow-lg hover:bg-blue-400 cursor-pointer"
